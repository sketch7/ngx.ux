...
export function _moduleConfigFactory(config: UxOptions | (() => UxOptions)): UxOptions {
	...
	const viewport = {
		resizePollingSpeed: uxOptions?.viewport?.resizePollingSpeed
			? uxOptions.viewport.resizePollingSpeed
			: UX_DEFAULT_CONFIG.viewport.resizePollingSpeed,
		breakpoints: uxOptions?.viewport?.breakpoints
			? uxOptions.viewport.breakpoints
			: UX_DEFAULT_CONFIG.viewport.breakpoints,

		viewportSsrSizes: {
			...UX_DEFAULT_CONFIG.viewport.viewportSsrSizes,
